...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 | LawyerEnquiry Form</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:#e74c3c";>Registered Lawyer </h3></div>
              <div class="col-sm-4">
...
<style>
  ...
  table tbody {
    background-color: #ffe4e1; /* Light pink for tbody */
  }
.table td, .table th {
      vertical-align: middle;
...
<body>
  ...
  <tr>
    ...
    <th>Bar No</th>
    <th>Address</th>
    <th>Edit</th>     <!-- Separate column for Edit -->
    <th>Delete</th>   <!-- Separate column for Delete -->
  </tr>
</thead>
  ...
  <?php while ($row = $result->fetch_assoc()): ?>
    <tr>
      ...
      <td><?= $row['address'] ?></td>
      <td>
        <a href="edit_lawyer.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">
          Edit
        </a>
      </td>
      <td>
        <a href="delete_lawyer.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger"
