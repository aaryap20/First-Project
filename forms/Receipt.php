...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 | Receipt Form</title>
      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_enquiry5.html" class="btn btn-primary" name="save" value="create">
                  Receipt Entry 
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0"style="color:darksalmon;">Receipt Entry Form </h3></div>
              <div class="col-sm-4">
...
<body class="bg-light p-5">
  ...
  <tr>
    ...
    <th>Details</th>
    <th>Created At</th>
    <th>Edit</th>         <!-- Separate column -->
    <th>Delete</th>       <!-- Separate column -->
  </tr>
</thead>
  ...
  <!-- Edit Button Column -->
  <td>
    <a href="edit_receipt.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">
  ...
  <td>
    <a href="delete_receipt.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this receipt?');">
      <i class="bi bi-trash"></i> Delete
          ...
          echo "<tr><td colspan='8' class='text-center'>No receipts found.</td></tr>";
        }
        ?>
      </tbody>
    </table>
    ...
    $(document).ready(function () {
      $('#example').DataTable({
        ...
        "language": {
          ...
          "info": "Showing START to END of TOTAL receipts",
          "infoEmpty": "No receipts available",
          "infoFiltered": "(filtered from MAX total receipts)"
        }
      });
    });
  </script>
