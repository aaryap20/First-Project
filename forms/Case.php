      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_enquiry3.html" class="btn btn-primary" name="save" value="create">
                  Case Registration 
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:#f5b041;"> Case Registration </h3></div>
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Case Registration </li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
    ...
    if ($result->num_rows > 0) {
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'>
                <a href='edit_case.php?id={$caseId}' class='btn btn-sm btn-info'>
                  <i class='bi bi-pencil'></i> Edit
                </a>
              </td>";
        // Delete button (with confirmation)
        echo "<td class='text-center'>
                <form method='post' action='delete_case.php' onsubmit=\"return confirm('Are you sure you want to delete this case?');\">
