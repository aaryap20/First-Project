            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../forms/lawyer.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Lawyer</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/client.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Client</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/case.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Case</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/appointment.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Appointment</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/receipt.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Receipt</p>
                    </a>
                  </li>
