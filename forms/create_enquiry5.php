...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 | Receipt Entry </title>
   ...
   <style>
    body {
  background: linear-gradient(to right, #fce4ec, #f3e5f5); /* Soft pink to lavender */
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini sidebar-collapse bg-body-tertiary" >
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0"> Receipt Entry Form</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Receipt Entry</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" id="date" name="receipt_date" required>
      </div>
      ...
      <div class="mb-3">
        <label for="details" class="form-label">Payment Details / Remarks</label>
