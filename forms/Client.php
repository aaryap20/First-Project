...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 |Client Enquiry Form</title>
      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_enquiry2.html" class="btn btn-primary" name="save" value="create">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:#f39c12";>Client Registration Form</h3></div>
              <div class="col-sm-4">
...
<script src="https://cdn.datatables.net/1.13.6/js/dataTables.bootstrap5.min.js"></script>
  <style>
  .body {
  background-color: #fdf2e9; /* Page background */
...
<body style="background-color:#fdf2e9;">
  ...
  <tr>
    ...
    <td class="text-center">
      <a href="edit_client.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary">
    ...
    <!-- Delete Button -->
    <td class="text-center">
      <a href="delete_client.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this client?');">
...
<script>
  $(document).ready(function () {
    const table = $('#lawyerTable').DataTable({
      pageLength: 5,
      lengthMenu: [5, 10, 25, 50]
    });
    ...
    $('#lawyerForm').on('submit', function (e) {
      ...
      table.row.add([
        name, phone, email, address, caseType, description, date
      ]).draw();
