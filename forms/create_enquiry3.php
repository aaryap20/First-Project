...
<link href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css" rel="stylesheet">
   ...
   <style>
    body {
      background: linear-gradient(to right, #d3cce3, #e9e4f0); /* Elegant gradient */
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini sidebar-collapse bg-body-tertiary" >
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0"> Case Registration Form</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Case Registration Form</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
    ...
    <div class="mb-3">
      <label for="case_title" class="form-label">Case_Title</label>
      <input type="text" class="form-control" id="case_title" name="case_title" required>
    </div>

    <div class="mb-3">
      <label for="case_number" class="form-label">Case_Number</label>
    ...
    <div class="mb-3">
      <label for="hearing_date" class="form-label"> Hearing_Date</label>
